...
module.exports.run = async (client, message, args) => {
  if ((message.channel.id == "724349410858893372") || (message.channel.id == "722436626248237076")) {
      messafe.channel.send("Вы можете уменьшить графический интерфейс, перейдя в «Настройки» -> «Настройки графики» и изменив масштаб графического интерфейса на «Обычный» или «Маленький».\n\nИспользуйте команду ;fixgui в игре, если после это всё ровно у вас маленькое меню или можете включить язык English (US)")
  }
  else {
