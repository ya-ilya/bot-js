...
module.exports.run = async (client, message, args) => {
    if ((message.channel.id == "724349410858893372") || (message.channel.id == "722436626248237076")) {
        message.channel.send("`;tsc` показывает разработчикам важную информацию по поиску и устранению неисправностей, которая помогает решить проблемы. Покажите снимок экрана с выводом этой команды при запуске в Minecraft")
    } else {
